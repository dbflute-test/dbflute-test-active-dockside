...
/**
 * The base class for parameter-bean of FreeSqlPagingMember.
 * @author DBFlute(AutoGenerator)
 */
public class BsFreeSqlPagingMemberPmb extends SimplePagingBean implements ParameterBean, FetchBean {
    ...
    //                                                                         ===========
    /**
     * Constructor for the parameter-bean of FreeSqlPagingMember.
     */
    public BsFreeSqlPagingMemberPmb() {
