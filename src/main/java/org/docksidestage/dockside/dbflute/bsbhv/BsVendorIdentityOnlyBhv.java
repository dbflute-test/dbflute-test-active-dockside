...
public abstract class BsVendorIdentityOnlyBhv extends AbstractBehaviorWritable<VendorIdentityOnly, VendorIdentityOnlyCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorIdentityOnlyBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * VendorIdentityOnly vendorIdentityOnly = <span style="color: #0000C0">vendorIdentityOnlyBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     ...
     * });
     * for (VendorIdentityOnly <span style="color: #553000">vendorIdentityOnly</span> : <span style="color: #553000">vendorIdentityOnlyList</span>) {
