...
public abstract class BsMemberFollowingBhv extends AbstractBehaviorWritable<MemberFollowing, MemberFollowingCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <pre>
     * MemberFollowing memberFollowing = <span style="color: #0000C0">memberFollowingBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     ...
     * });
     * for (MemberFollowing <span style="color: #553000">memberFollowing</span> : <span style="color: #553000">memberFollowingList</span>) {
