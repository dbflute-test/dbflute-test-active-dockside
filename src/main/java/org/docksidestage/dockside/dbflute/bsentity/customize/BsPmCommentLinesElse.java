...
public abstract class BsPmCommentLinesElse extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dockside.dbflute.bsentity.customize.dbmeta.PmCommentLinesElseDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "PmCommentLinesElse";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPmCommentLinesElse) {
            BsPmCommentLinesElse other = (BsPmCommentLinesElse)obj;
    ...
    @Override
    public PmCommentLinesElse clone() {
        return (PmCommentLinesElse)super.clone();
    }
