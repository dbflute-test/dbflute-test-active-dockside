...
/**
 * The entity of CursorWithScalarMember. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsCursorWithScalarMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dockside.dbflute.bsentity.customize.dbmeta.CursorWithScalarMemberDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "CursorWithScalarMember";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsCursorWithScalarMember) {
            BsCursorWithScalarMember other = (BsCursorWithScalarMember)obj;
    ...
    @Override
    public CursorWithScalarMember clone() {
        return (CursorWithScalarMember)super.clone();
    }
