...
public abstract class BsPagingWithListMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dockside.dbflute.bsentity.customize.dbmeta.PagingWithListMemberDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "PagingWithListMember";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPagingWithListMember) {
            BsPagingWithListMember other = (BsPagingWithListMember)obj;
    ...
    @Override
    public PagingWithListMember clone() {
        return (PagingWithListMember)super.clone();
    }
