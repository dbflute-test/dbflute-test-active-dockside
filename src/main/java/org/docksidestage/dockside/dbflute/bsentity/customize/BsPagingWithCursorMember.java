...
/**
 * The entity of PagingWithCursorMember. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsPagingWithCursorMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dockside.dbflute.bsentity.customize.dbmeta.PagingWithCursorMemberDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "PagingWithCursorMember";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPagingWithCursorMember) {
            BsPagingWithCursorMember other = (BsPagingWithCursorMember)obj;
    ...
    @Override
    public PagingWithCursorMember clone() {
        return (PagingWithCursorMember)super.clone();
    }
