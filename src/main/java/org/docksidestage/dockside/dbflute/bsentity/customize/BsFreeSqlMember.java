...
/**
 * The entity of FreeSqlMember. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsFreeSqlMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dockside.dbflute.bsentity.customize.dbmeta.FreeSqlMemberDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "FreeSqlMember";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFreeSqlMember) {
            BsFreeSqlMember other = (BsFreeSqlMember)obj;
    ...
    @Override
    public FreeSqlMember clone() {
        return (FreeSqlMember)super.clone();
    }
