...
public class MemberWithdrawalDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnWithdrawalDatetime = cci("WITHDRAWAL_DATETIME", "WITHDRAWAL_DATETIME", null, null, java.time.LocalDateTime.class, "withdrawalDatetime", null, false, false, true, "TIMESTAMP", 26, 6, null, null, false, null, null, null, null, null, false);
    ...
    /**
     * WITHDRAWAL_DATETIME: {NotNull, TIMESTAMP(26, 6)}
     * @return The information object of specified column. (NotNull)
     */
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.dockside.dbflute.exentity.MemberWithdrawal"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.dockside.dbflute.cbean.MemberWithdrawalCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.dockside.dbflute.exbhv.MemberWithdrawalBhv"; }
