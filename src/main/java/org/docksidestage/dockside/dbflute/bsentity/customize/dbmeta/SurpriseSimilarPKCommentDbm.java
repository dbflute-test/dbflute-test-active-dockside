...
public class SurpriseSimilarPKCommentDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((SurpriseSimilarPKComment)et).getRegisterDatetime(), (et, vl) -> ((SurpriseSimilarPKComment)et).setRegisterDatetime(ctldt(vl)), "registerDatetime");
        ...
        setupEpg(_epgMap, et -> ((SurpriseSimilarPKComment)et).getUpdateDatetime(), (et, vl) -> ((SurpriseSimilarPKComment)et).setUpdateDatetime(ctldt(vl)), "updateDatetime");
    ...
    protected final ColumnInfo _columnRegisterDatetime = cci("REGISTER_DATETIME", "REGISTER_DATETIME", null, "登録日時", java.time.LocalDateTime.class, "registerDatetime", null, false, false, false, "TIMESTAMP", 23, 10, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnRegisterUser = cci("REGISTER_USER", "REGISTER_USER", null, "登録ユーザ", String.class, "registerUser", null, false, false, false, "VARCHAR", 200, 0, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnUpdateDatetime = cci("UPDATE_DATETIME", "UPDATE_DATETIME", null, "更新日時", java.time.LocalDateTime.class, "updateDatetime", null, false, false, false, "TIMESTAMP", 23, 10, null, null, true, null, null, null, null, null, false);
    protected final ColumnInfo _columnUpdateUser = cci("UPDATE_USER", "UPDATE_USER", null, "更新ユーザ", String.class, "updateUser", null, false, false, false, "VARCHAR", 200, 0, null, null, true, null, null, null, null, null, false);
