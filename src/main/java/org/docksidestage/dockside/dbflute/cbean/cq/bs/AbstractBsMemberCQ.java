...
public abstract class AbstractBsMemberCQ extends AbstractConditionQuery {
     ...
     * (会員フォローイング)MEMBER_FOLLOWING by MY_MEMBER_ID, named 'memberFollowingByMyMemberIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedMemberFollowingByMyMemberId()</span>.<span style="color: #DD4747">max</span>(followingCB -&gt; {
     ...
     * (会員フォローイング)MEMBER_FOLLOWING by YOUR_MEMBER_ID, named 'memberFollowingByYourMemberIdAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedMemberFollowingByYourMemberId()</span>.<span style="color: #DD4747">max</span>(followingCB -&gt; {
     *     followingCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
     *     followingCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
     * }).<span style="color: #DD4747">greaterEqual</span>(123); <span style="color: #3F7E5E">// condition to derived column</span>
     * </pre>
     ...
     * (会員ログイン)MEMBER_LOGIN by MEMBER_ID, named 'memberLoginAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedMemberLogin()</span>.<span style="color: #DD4747">max</span>(loginCB -&gt; {
    ...
    public void setMemberAccount_LikeSearch(String memberAccount, COptionCall<LikeSearchOption> opLambda) {
        LikeSearchOption op = cLSOP(); opLambda.callback(op);
        setMemberAccount_LikeSearch(memberAccount, op);
    }
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setMemberAccount_NotLikeSearch(String memberAccount, COptionCall<LikeSearchOption> opLambda) {
        LikeSearchOption op = cLSOP(); opLambda.callback(op);
        setMemberAccount_NotLikeSearch(memberAccount, op);
    }
    ...
    public void setFormalizedDatetime_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
        ...
        setFormalizedDatetime_FromTo(fromDatetime, toDatetime, op);
    }
    ...
    public void setBirthdate_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
        FromToOption op = cFTOP(); opLambda.callback(op);
        setBirthdate_FromTo(fromDatetime, toDatetime, op);
    }
