...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("PURCHASE_PAYMENT", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("REGION", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("SUMMARY_WITHDRAWAL", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("VENDOR_$_DOLLAR", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.Vendor$DollarDbm");
        tmpMap.put("VENDOR_CHECK", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("VENDOR_IDENTITY_ONLY", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.VendorIdentityOnlyDbm");
        tmpMap.put("VENDOR_PRIMARY_KEY_ONLY", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.VendorPrimaryKeyOnlyDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnRefDbm");
        tmpMap.put("WITHDRAWAL_REASON", "org.docksidestage.dockside.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
